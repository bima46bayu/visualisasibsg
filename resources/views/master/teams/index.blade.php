...
<div class="bg-white rounded-xl shadow-sm border border-gray-100 p-6">
    <div class="flex justify-between items-center mb-4">
        <form action="{{ route('teams.index') }}" method="GET" class="flex space-x-2">
        ...
        <a href="{{ route('teams.create') }}" class="bg-emerald-600 text-white px-4 py-2 rounded-lg text-sm font-medium hover:bg-emerald-700">+ Tambah Team</a>
    </div>
            ...
            <tbody class="divide-y divide-gray-200 text-sm">
                ...
                <tr class="hover:bg-gray-50 transition">
                    ...
                    <td class="px-6 py-4 text-right space-x-2">
                        <a href="{{ route('teams.edit', $team) }}" class="text-blue-600 hover:text-blue-800 font-medium">Edit</a>
                        <form action="{{ route('teams.destroy', $team) }}" method="POST" class="inline-block" onsubmit="return confirm('Yakin hapus team ini?')">
                            @csrf @method('DELETE')
