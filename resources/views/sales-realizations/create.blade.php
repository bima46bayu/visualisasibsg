...
@section('header', 'Tambah Sales Realisasi')
    ...
    <form action="{{ route('sales-realizations.store') }}" method="POST">
        ...
        <div class="space-y-4">
            ...
            <div>
                ...
                <input type="number" name="realization_amount" min="0" value="{{ old('realization_amount', 0) }}" required class="w-full border-gray-300 rounded-lg text-sm focus:ring-blue-500 focus:border-blue-500">
